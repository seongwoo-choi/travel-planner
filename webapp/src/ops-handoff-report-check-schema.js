...
import {
  HANDOFF_CHECK_FIELD_REASON_VALUES,
  HANDOFF_REJECTED_FIELD_REASON_VALUES,
...
function buildSchema() {
  return {
    ...
    $id: 'https://travel-planner.local/schemas/handoff-report-check.schema.json',
    title: 'Travel Planner handoff report check result',
    metadata: {
      target: 'handoff-report-check-result',
      artifact: 'handoff-report-check.json',
    ...
    properties: {
      ...
      statusField: {
        type: 'object',
        additionalProperties: false,
        required: ['present', 'value', 'draft', 'accepted', 'allowedValues', 'guidance'],
        properties: {
          ...
          allowedValues: {
            type: 'array',
            items: { type: 'string', enum: ['ready', 'signed-off'] },
          },
      ...
      fields: {
        ...
        items: {
          ...
          properties: {
            ...
            scope: { type: 'string', enum: ['header', 'section'] },
            present: { type: 'boolean' },
            accepted: { type: 'boolean' },
            reason: {
              type: 'string',
              enum: HANDOFF_CHECK_FIELD_REASON_VALUES,
            },
          },
        },
      },
      ...
      rejectedFields: {
        ...
        items: {
          ...
          properties: {
            ...
            reason: {
              type: 'string',
              enum: HANDOFF_REJECTED_FIELD_REASON_VALUES,
            },
          },
        },
      },
      ...
      rejectedFieldReasons: {
        ...
        default: {},
        type: 'object',
        maxProperties: HANDOFF_REJECTED_FIELD_REASON_VALUES.length,
        propertyNames: {
          enum: HANDOFF_REJECTED_FIELD_REASON_VALUES,
        },
      ...
      rejectedFieldReasonEntries: {
        ...
        default: [],
        type: 'array',
        maxItems: HANDOFF_REJECTED_FIELD_REASON_VALUES.length,
        uniqueItems: true,
        items: {
          type: 'object',
          additionalProperties: false,
...
try {
  ...
  console.error(`ops-handoff-report-check-schema failed: ${error.message}`);
  process.exitCode = 1;
}
